...
Xinha.Config = function()
{
 ...
 /** You can tell the fullscreen mode to leave certain margins on each side.<br />
  ...
  this.btnList =
  {
    bold: [ "Bold", Xinha._lc({key: 'button_bold', string: 'tango/16x16/actions/format-text-bold.png'}, 'Xinha'), false, function(e) { e.execCommand("bold"); } ],
    ...
    justifyright: [ "Justify Right", 'tango/16x16/actions/format-justify-right.png', false, function(e) { e.execCommand("justifyright"); } ],
    justifyfull: [ "Justify Full", 'tango/16x16/actions/format-justify-fill.png', false, function(e) { e.execCommand("justifyfull"); } ],
    ...
    selectall: [ "Select all", 'tango/16x16/actions/edit-select-all.png', false, function(e) {e.execCommand("selectall");} ],
    ...
    insertimage: [ "Insert/Modify Image", 'tango/16x16/mimetypes/image-x-generic.png', false, function(e) { e.execCommand("insertimage"); } ],
    ...
    print: [ "Print document", 'tango/16x16/actions/document-print.png', false, function(e) { if(Xinha.is_gecko) {e._iframe.contentWindow.print(); } else { e.focusEditor(); print(); } } ],
    ...
    removeformat: [ "Remove formatting", 'tango-art-libre/16x16/tools/draw-eraser.png', false, function(e) { e.execCommand("removeformat"); } ],

...
HTMLArea.is_designMode = (typeof document.designMode != 'undefined');
...
HTMLArea.prototype.generate = function ()
{
  ...
  // Opera doesn't work with the event on the iframe, we have the blank page that gets
  //  loaded tell us when ready.
  ...
  HTMLArea.prototype.editorIsActivated = function() {
    try {
      if (HTMLArea.is_designMode) return (this._doc.designMode == 'on');
  ...
  HTMLArea.prototype.activateEditor = function()
  {
    ...
    if (HTMLArea.is_designMode && this._doc.designMode != 'on')
    {
      try
      {
  ...
  HTMLArea.prototype.deactivateEditor = function()
  {
    ...
    if (HTMLArea.is_designMode && this._doc.designMode != 'off')
    {
...
HTMLArea.checkSupportedBrowser = function() {
  ...
  return HTMLArea.is_ie || HTMLArea.is_designMode;
};

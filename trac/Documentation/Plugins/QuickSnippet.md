...
[Back to Plugins](Plugins.html)
  ...
  [InsertSnippet2](Documentation/Plugins/InsertSnippet2.html) xml files are compatible, if you already use `InsertSnippet2` just remove that from your plugins list and load `QuickSnippet` instead and it will use the `InsertSnippet2` configuration.
...
consult [InsertSnippet2](Documentation/Plugins/InsertSnippet2.html) for details on that XML format.

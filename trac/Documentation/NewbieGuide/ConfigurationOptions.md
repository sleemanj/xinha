...
** See the [NewbieGuide](NewbieGuide#ProvideSomeConfiguration.html) for how to set configuration values in general. **
...
```
  ...
  pageStyle::
    String. CSS definitions to apply to the edited document.  See also pageStyleSheets below, and [Stylist](Stylist.html) plugin.
```

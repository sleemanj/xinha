...
Please read [Entize Your Data](Documentation/NewbieGuide/Entize.html) for more information.
...
Please read [Character Sets in Xinha](Documentation/NewbieGuide/CharacterSets.html) for more information.
...
Please read [Installing Xinha](Documentation/NewbieGuide/InstallingXinha.html) for more information.
...
See [Caching Xinha](Documentation/NewbieGuide/Caching.html) for an example.
...
[Xinha Core](Documentation/NewbieGuide/ConfigurationOptions.html) and it's [Plugins](Plugins.html) have lots of scope to configure them as you require, this is how you can set configuration settings in general.
...
it may be that you wish to develop your own Xinha plugins and keep them separate to Xinha (or you use Xinha from a CDN), or you wish to use plugins such as [Linker](Documentation/Plugins/Linker.html) and [MootoolsFileManager](Documentation/Plugins/MootoolsFileManager.html) which must be run on your own webserver because they allow browsing or uploading files on your webserver.  

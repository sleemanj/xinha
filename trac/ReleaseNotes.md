...
### New Plugins
  ...
  * [UseStrongEm](Documentation/Plugins/UseStrongEm.html) Plugin

### New Features

  * Added `preserveI` and `preserveB` [configuration options](Documentation/NewbieGuide/ConfigurationOptions.html)
...
### New Plugins
  ...
  * [1444] Add new [QuickSnippet](Documentation/Plugins/QuickSnippet.html) Plugin
...
### Bugs Fixed
  * #1595 suhoshin caused issues with [MootoolsFileManager](Documentation/Plugins/MootoolsFileManager.html)
  * #1619 dTree's Node object conflicting with DOM
  * [1332] iPhone/iPad Fixes
  * [1332] [Stylist](Documentation/Plugins/Stylist.html) startup reliablility fix
  * [1336] Fix for a console warning in Chrome
  * #1609  Rename the CSS plugin to [CSSDropDowns](Documentation/Plugins/CSSDropDowns.html) to avoid the native CSS Object in Firefox
  * #1601  Fix status bar width
  * #1589  Fix crash in [Equation](Documentation/Plugins/Equation.html) plugin
  ...
  * #1480  Fix some oddities with [InsertAnchor](Documentation/Plugins/InsertAnchor.html) plugin
  ...
  * [1360] Small fix for [SmartReplace](Documentation/Plugins/SmartReplace.html) plugin
  * #1279  Change ereg to preg in [SuperClean](Documentation/Plugins/SuperClean.html) tidy php 
  ...
  * #1358  Hide [SmartReplace](Documentation/Plugins/SmartReplace.html) when in textmode
...
### New Features and Improvements
  * Add a new way of loading Xinha which is much easier, called `XinhaEasy.js`, this can also be used from a CDN type arrangement, even if you want to use PHP plugins (which are on your local server).  See the examples and the [NewbieGuide](Documentation/NewbieGuide.html)
  ...
  * #1391  Improve [PreserveScripts](Documentation/Plugins/PreserveScripts.html) plugin.
  * #1511  Improve [SuperClean](Documentation/Plugins/SuperClean.html) plugin
  * #1476  Improve [ContextMenu](Documentation/Plugins/ContextMenu.html) when using native browser spell checking
  * #1432  Support title attribute in the [Linker](Documentation/Plugins/Linker.html) plugin
  * #1343  Add some Turkish translations
  * #1489  Add some Portuguese Brazilian translations
  * #1163  Add editing support for th in [TableOperations](Documentation/Plugins/TableOperations.html)
  ...
  * [1371] Update [MootoolsFileManager](Documentation/Plugins/MootoolsFileManager.html) to no longer require Flash (uses HTML5 uploading) amongst some other small improvements.
  * [1378] Improve handling of tab key, add configuration `tabSpanClass` and `tabSpanContents`
  * #1617  Implement tab/shift-tab for [TableOperations](Documentation/Plugins/TableOperations.html)
  * #1163  Allow changing table cells between td/th in [TableOperations](Documentation/Plugins/TableOperations.html)
  * #1550  Make some features of [TableOperations](Documentation/Plugins/TableOperations.html) less confusing and improve border styling.
  ...
  * #1135  Update [SuperClean](Documentation/Plugins/SuperClean.html) to incorporate `UnFormat` functionality
...
### New Plugins
  * [WebKitResize](Documentation/Plugins/WebKitResize.html) Provides drag-resize for images, tables and table cells in `WebKit` Browsers, also for tables and cells in Gecko Browsers.
  * [EncodeOutput](Documentation/Plugins/EncodeOutput.html) Provides ability to encode the generated HTML of Xinha in some manners before submitting it to the server, for example to avoid mod_security issues.
  * [ListOperations](Documentation/Plugins/ListOperations.html) Provides tab/shift-tab functionality when editing lists ( #1614 )
  * [FancySelects](Documentation/Plugins/FancySelects.html) Provides "fancy" selects for the font style etc which show the font in use.  Uses the select2 jQuery component behind the scenes (jQuery is loaded automatically if necessary).
  * [PreserveSelection](Documentation/Plugins/PreserveSelection.html) Allows selected text in the WYSIWYG view to also be selected when you switch to textmode (#1544)
    
  
### Deprecated Plugins
  * [1351] Deprecate [SpellChecker](Documentation/Plugins/SpellChecker.html) plugin, native browser spell checking works well enough and executing aspell on hosts never really worked that reliably.
  * [1355] Deprecate the `PersistentStorage` and associated plugins, these are abandoned.
  * [1366] Deprecate [ExtendedFileManager](Documentation/Plugins/ExtendedFileManager.html) and [ImageManager](Documentation/Plugins/ImageManager.html), the [MootoolsFileManager](Documentation/Plugins/MootoolsFileManager.html) should be used instead of both.
  * #1135  Deprecate `UnFormat`, [SuperClean](Documentation/Plugins/SuperClean.html) now has it's features.

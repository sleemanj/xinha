...
Xinha is open source, and we mean it, if you want to progress the development of Xinha in some way, please contact James Sleeman ( See [Xinha Developers]({{ site.baseurl }}/trac/Developers.html) ) and he will arrange for SVN commit and Trac management access.

...
HTMLArea.prependDom0Event(_1._textArea.form,"submit",function(){
_3.unParse();
_3.reParse=true;
});
}
if(typeof AMprocessNode!="function"){
HTMLArea._loadback(_editor_url+"plugins/Equation/ASCIIMathML.js",function(){
translate();
});
}
}
HTMLArea.Config.prototype.Equation={"mathcolor":"red","mathfontfamily":"serif"};
...
var _16={};
_16["editor"]=_15;
var _17=_15._getFirstAncestor(_15._getSelection(),["span"]);
if(_17){
_16["editedNode"]=_17;
}

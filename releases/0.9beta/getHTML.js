HTMLArea.getHTML=function(_1,_2,_3){
try{
return HTMLArea.getHTMLWrapper(_1,_2,_3);
}
catch(ex){
...
HTMLArea.getHTMLWrapper=function(_4,_5,_6,_7){
var _8="";
if(!_7){
_7="";
}
...
if(HTMLArea.is_ie&&_b=="head"){
if(_5){
_8+=(HTMLArea.is_ie?("\n"+_7):"")+"<head>";
}
var _c=RegExp.multiline;
RegExp.multiline=true;
var _d=_4.innerHTML.replace(HTMLArea.RE_tagName,function(_e,p1,p2){
...
if(_5){
_9=(!(_4.hasChildNodes()||HTMLArea.needsClosingTag(_4)));
_8+=(HTMLArea.is_ie&&HTMLArea.isBlockElement(_4)?("\n"+_7):"")+"<"+_4.tagName.toLowerCase();
var _11=_4.attributes;
for(i=0;i<_11.length;++i){
var a=_11.item(i);
if(!a.specified&&!(_4.tagName.toLowerCase().match(/input|option/)&&a.nodeName=="value")){
continue;
}
...
_14=a.nodeValue;
if(HTMLArea.is_ie&&(_13=="href"||_13=="src")){
...
_8+=" "+_13+"=\""+HTMLArea.htmlEncode(_14)+"\"";
}
if(_8!==""){
if(_9&&_b=="p"){
_8+=">&nbsp;</p>";
...
_8+=_17+"</"+_b+">"+((HTMLArea.is_ie)?"\n":"");
}
}else{
for(i=_4.firstChild;i;i=i.nextSibling){
if(!_16&&i.nodeType==1&&HTMLArea.isBlockElement(i)){
_16=true;
}
_8+=HTMLArea.getHTMLWrapper(i,true,_6,_7+"  ");
}
if(_5&&!_9){
_8+=(HTMLArea.is_ie&&HTMLArea.isBlockElement(_4)&&_16?("\n"+_7):"")+"</"+_4.tagName.toLowerCase()+">";
}
}
break;
case 3:
_8=/^script|style$/i.test(_4.parentNode.tagName)?_4.data:HTMLArea.htmlEncode(_4.data);
break;
case 8:
_8="<!--"+_4.data+"-->";
break;

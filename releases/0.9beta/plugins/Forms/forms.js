...
var id=_7[0];
if(i<3){
_2.registerButton(id,HTMLArea._lc(_7[1]),_1.imgURL("ed_"+_7[0]+".gif","Forms"),false,function(_9,id){
_4.buttonPress(_9,id);
});
}else{
_2.registerButton(id,HTMLArea._lc(_7[1]),_1.imgURL("ed_"+_7[0]+".gif","Forms"),false,function(_b,id){
...
if(frm){
frm.name=_1b["f_name"];
setAttr(frm,"action",_1b["f_action"]);
setAttr(frm,"method",_1b["f_method"]);
setAttr(frm,"enctype",_1b["f_enctype"]);
setAttr(frm,"target",_1b["f_target"]);
}else{
...
if(_12){
for(field in _20){
alert(field.substring(2,20)+"="+_20[field]);

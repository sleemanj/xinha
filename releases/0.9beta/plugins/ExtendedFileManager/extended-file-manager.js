...
HTMLArea.Config.prototype.ExtendedFileManager={"use_linker":true,"backend":_editor_url+"plugins/ExtendedFileManager/backend.php?__plugin=ExtendedFileManager&","backend_data":null,"backend_config":null,"backend_config_hash":null,"backend_config_secret_key_location":"Xinha:ImageManager"};
...
if(HTMLArea.is_ie){
var _d=_7._getSelection();
var _e=_7._createRange(_d);
...
HTMLArea.prototype._linkFile=function(_10){
var _11=this;
var _12=null;
...
_12={f_href:"",f_title:"",f_target:"",f_usetarget:_11.config.makeLinkShowsTarget,baseHref:_11.config.baseHref};
}else{
_12={f_href:HTMLArea.is_ie?_10.href:_10.getAttribute("href"),f_title:_10.title,f_target:_10.target,f_usetarget:_11.config.makeLinkShowsTarget,baseHref:_11.config.baseHref};
}
...
_23+=HTMLArea._colorToRgb(_22[i]);
if(i+1<_22.length){
_23+=" ";
}
}
...
return HTMLArea._colorToRgb(_21);
}

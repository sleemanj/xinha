...
HTMLArea.Config.prototype.Linker={"backend":_editor_url+"plugins/Linker/scan.php","backend_data":null,"files":null};
...
HTMLArea._loadback(_editor_url+"plugins/Linker/dTree/dtree.js",function(){
_24._prepareDialog();
});
return;
}
...
HTMLArea._postback(_25.lConfig.backend,_25.lConfig.backend_data,function(txt){
try{
eval("var f = "+txt);
_24.files=f;
}
...
var _29=this.html;
var _2a=this.dialog=new HTMLArea.Dialog(_25.editor,this.html,"Linker");
var _2b=HTMLArea.uniq("dTree_");

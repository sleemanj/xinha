...
HTMLArea.prototype.getParentElement=function(_2){
...
HTMLArea.prototype._activeElement=function(_6){
...
HTMLArea.prototype._selectionEmpty=function(_9){
if(!_9){
return true;
}
return this._createRange(_9).htmlText==="";
};
HTMLArea.prototype.selectNodeContents=function(_a,_b){
this.focusEditor();
this.forceRedraw();
var _c;
...
HTMLArea.prototype.insertHTML=function(_e){
...
HTMLArea.getOuterHTML=function(_19){
return _19.outerHTML;
};
HTMLArea.prototype._formatBlock=function(_1a){
};

HTMLArea.prototype.insertNodeAtSelection=function(_1){
...
HTMLArea.prototype.getParentElement=function(_7){
...
HTMLArea.prototype._activeElement=function(_a){
...
HTMLArea.prototype._selectionEmpty=function(_b){
if(!_b){
return true;
}
...
HTMLArea.prototype.selectNodeContents=function(_c,_d){
this.focusEditor();
this.forceRedraw();
var _e;
...
HTMLArea.prototype.insertHTML=function(_11){
var sel=this._getSelection();
...
return HTMLArea.getHTML(_18.cloneContents(),false,this);
};
...
HTMLArea.getOuterHTML=function(_24){
return (new XMLSerializer()).serializeToString(_24);
};
HTMLArea.prototype._formatBlock=function(_25){
...
HTMLArea.prototype.mozKey=function(ev,_31){
var _32=this;
...
var _3d=_3c.match(HTMLArea.RE_email);
if(_3d){
...
var _41=_3c.match(HTMLArea.RE_url);
if(_41){
if(RE_date.test(_3c)){
if(!RE_ip.test(_3c)){
break;
...
var _4a=function(){
m=_49.data.match(HTMLArea.RE_url);

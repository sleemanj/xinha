...
_c.style.height="12px";
_c.style.width="12px";
_c.style.border="2px outset";
...
colorPicker.remember(this.colorCode,_29.savecolors);
...
_33.appendChild(document.createTextNode("Web Safe: "));
...
_33.style.fontFamily="small-caption,caption,sans-serif";
_33.style.fontSize="x-small";
_33.appendChild(document.createTextNode("Color: "));
...
colorPicker.remember(_29.chosenColor.value,_29.savecolors);
...
for(var _3e=0;_3e<colorPicker.savedColors.length;_3e++){
createSavedColors(colorPicker.savedColors[_3e]);
}
td.appendChild(_3a);
this.tbody.appendChild(tr);
...
colorPicker.remember=function(_40,_41){
for(var i=colorPicker.savedColors.length;i--;){
if(colorPicker.savedColors[i]==_40){
return false;
}
}
colorPicker.savedColors.splice(0,0,_40);
colorPicker.savedColors=colorPicker.savedColors.slice(0,_41);
var _43=new Date();
_43.setMonth(_43.getMonth()+1);
document.cookie="XinhaColorPicker="+escape(colorPicker.savedColors.join("-"))+";expires="+_43.toGMTString();
return true;
};
...
colorPicker.savedColors=unescape(document.cookie.substring(_45,end)).split("-");
}
};

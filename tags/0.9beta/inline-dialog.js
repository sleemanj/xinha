HTMLArea.Dialog=function(_1,_2,_3){
this.id={};
this.r_id={};
this.editor=_1;
...
HTMLArea.Dialog.prototype.show=function(_f){
if(HTMLArea.is_ie){
...
HTMLArea.Dialog.prototype.setValues=function(_10){
for(var i in _10){
...
var _17=[];
var _18=HTMLArea.collectionToArray(this.rootElem.getElementsByTagName("input")).append(HTMLArea.collectionToArray(this.rootElem.getElementsByTagName("textarea"))).append(HTMLArea.collectionToArray(this.rootElem.getElementsByTagName("select")));
...
HTMLArea.Dialog.prototype.getElementsByName=function(_1e){

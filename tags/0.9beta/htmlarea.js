HTMLArea.version={"Release":"Trunk","Head":"$HeadURL: http://svn.xinha.python-hosting.com/tags/0.9beta/htmlarea.js $".replace(/^[^:]*: (.*) \$$/,"$1"),"Date":"$LastChangedDate: 2007-01-11 04:50:20 +0100 (Do, 11 Jan 2007) $".replace(/^[^:]*: ([0-9-]*) ([0-9:]*) ([+0-9]*) \((.*)\) \$/,"$4 $2 $3"),"Revision":"$LastChangedRevision: 635 $".replace(/^[^:]*: (.*) \$$/,"$1"),"RevisionBy":"$LastChangedBy: ray $".replace(/^[^:]*: (.*) \$$/,"$1")};
...
HTMLArea._loadback(_editor_url+"getHTML.js",function(){
_8b.generate();
});
return false;
}
if(typeof HTMLArea.prototype._insertImage=="undefined"){
HTMLArea._loadback(_editor_url+"popups/insert_image.js",function(){
_8b.generate();
});
return false;
}
if(typeof HTMLArea.prototype._createLink=="undefined"&&typeof Linker=="undefined"){
HTMLArea._loadback(_editor_url+"popups/link.js",function(){
_8b.generate();
});
return false;
}
...
if(HTMLArea.is_ie){
HTMLArea._loadback(_editor_url+"functionsIE.js",_e3);
}else{
HTMLArea._loadback(_editor_url+"functionsMozilla.js",_e3);
}
return false;
}
while(_e5.length){
...
HTMLArea.prototype._getFirstAncestor=function(sel,_139){
...
HTMLArea.prototype.surroundHTML=function(_140,_141){
...
if(!HTMLArea.is_gecko||_153!=="blockquote"){
_153="<"+_153+">";
}
this.execCommand(txt,false,_153);
break;
...
HTMLArea.prototype._colorSelector=function(_155){
var _156=this;
...
if(HTMLArea.is_ie){
_155="backcolor";
_158=HTMLArea._colorToRgb(_156._doc.queryCommandValue("backcolor"));
}else{
_158=HTMLArea._colorToRgb(_156._doc.queryCommandValue("hilitecolor"));
}
}else{
_158=HTMLArea._colorToRgb(_156._doc.queryCommandValue("forecolor"));
}
...
HTMLArea.prototype.execCommand=function(_15e,UI,_160){
var _161=this;
this.focusEditor();
...
var _165=this;
var _166=(HTMLArea.is_ie&&ev.type=="keydown")||(!HTMLArea.is_ie&&ev.type=="keypress");
if(typeof _165._textArea["on"+ev.type]=="function"){
_165._textArea["on"+ev.type]();
}
if(HTMLArea.is_gecko&&_166&&ev.ctrlKey&&this._unLink&&this._unlinkOnUndo){
...
break;
case "v":
if(HTMLArea.is_ie||_16a.config.htmlareaPaste){
cmd="paste";
}
break;
case "n":
cmd="formatblock";
_16f=HTMLArea.is_ie?"<p>":"p";
break;
case "0":
cmd="killword";
break;
...
HTMLArea.prototype.convertNode=function(el,_171){
...
if(!HTMLArea.isBlockElement(_17d.previousSibling)){
...
var _19c=new RegExp(document.location.href.replace(/&/g,"&amp;").replace(HTMLArea.RE_Specials,"\\$1")+"(#[^'\" ]*)","g");
html=html.replace(_19c,"$1");
}
if(typeof this.config.stripBaseHref!="undefined"&&this.config.stripBaseHref){
var _19d=null;
if(typeof this.config.baseHref!="undefined"&&this.config.baseHref!==null){
_19d=new RegExp("((href|src|background)=\")("+this.config.baseHref.replace(HTMLArea.RE_Specials,"\\$1")+")","g");
}else{
_19d=new RegExp("((href|src|background)=\")("+document.location.href.replace(/([^\/]*\/?)$/,"").replace(HTMLArea.RE_Specials,"\\$1")+")","g");
}
...
HTMLArea.prototype.setDoctype=function(_1a0){
this.doctype=_1a0;
};
...
_1a2[n]=HTMLArea.cloneObject(node);
}else{
_1a2[n]=node;
}
}
...
HTMLArea._addEvent=function(el,_1a8,func){
el.addEventListener(_1a8,func,true);
HTMLArea._eventFlushers.push([el,_1a8,func]);
};
HTMLArea._removeEvent=function(el,_1ab,func){
...
HTMLArea._addEvent=function(el,_1af,func){
el.attachEvent("on"+_1af,func);
HTMLArea._eventFlushers.push([el,_1af,func]);
};
HTMLArea._removeEvent=function(el,_1b2,func){
...
HTMLArea._addEvent=function(el,_1b6,func){
alert("_addEvent is not supported");
};
HTMLArea._removeEvent=function(el,_1b9,func){
...
HTMLArea._removeClass=function(el,_1d6){
if(!(el&&el.className)){
return;
}
...
HTMLArea._addClass=function(el,_1db){
HTMLArea._removeClass(el,_1db);
el.className+=" "+_1db;
};
HTMLArea._hasClass=function(el,_1dd){
if(!(el&&el.className)){
return false;
}
var cls=el.className.split(" ");
...
HTMLArea.prototype.stripBaseURL=function(_1e4){
...
HTMLArea.prototype._popupDialog=function(url,_1f0,init){
Dialog(this.popupURL(url),_1f0,init);
};
HTMLArea.prototype.imgURL=function(file,_1f3){
...
HTMLArea._addClass(_1fb[i],"htmtableborders");
}else{
HTMLArea._removeClass(_1fb[i],"htmtableborders");
}
}
}
return true;
};
HTMLArea.addClasses=function(el,_1fe){
if(el!==null){
...
HTMLArea.removeClasses=function(el,_205){
...
HTMLArea._postback=function(url,data,_20e){
var req=null;
if(HTMLArea.is_ie){
...
HTMLArea._getback=function(url,_213){
var req=null;
if(HTMLArea.is_ie){
req=new ActiveXObject("Microsoft.XMLHTTP");
}else{
...
HTMLArea.arrayFilter=function(a1,_222){
var _223=[];
...
HTMLArea.uniq=function(_225){
return _225+HTMLArea.uniq_count++;
};
HTMLArea._loadlang=function(_226){
var url,lang;
...
var _228=HTMLArea._geturlcontent(url);
if(_228!==""){
try{
eval("lang = "+_228);
}
...
HTMLArea._lc=function(_229,_22a,_22b){
var ret;
var m=null;
...
if(typeof HTMLArea._lc_catalog[_22a]=="undefined"){
HTMLArea._lc_catalog[_22a]=HTMLArea._loadlang(_22a);
}
var key;
...
if(typeof HTMLArea._lc_catalog[_22a][key]=="undefined"){
if(_22a=="HTMLArea"){
if(typeof _229=="object"&&_229.string){
ret=_229.string;
}else{
...
return HTMLArea._lc(_229,"HTMLArea",_22b);
}
}else{
ret=HTMLArea._lc_catalog[_22a][key];
}
}
...
HTMLArea.collectionToArray=function(_23a){
var _23b=[];
...
HTMLArea.makeEditors=function(_23f,_240,_241){
if(typeof _240=="function"){
_240=_240();
}
var _242={};
for(var x=0;x<_23f.length;x++){
var _244=new HTMLArea(_23f[x],HTMLArea.cloneObject(_240));
_244.registerPlugins(_241);
_242[_23f[x]]=_244;
}
return _242;
};
HTMLArea.startEditors=function(_245){
for(var i in _245){
if(_245[i].generate){
_245[i].generate();
}
...
HTMLArea.prototype.registerPlugins=function(_247){
if(_247){
for(var i=0;i<_247.length;i++){
this.setLoadingMessage("Register plugin $plugin","HTMLArea",{"plugin":_247[i]});
this.registerPlugin(eval(_247[i]));
}
}
};
HTMLArea.base64_encode=function(_249){
...
HTMLArea.base64_decode=function(_24f){
...
HTMLArea.viewportSize=function(_258){
...
HTMLArea.prototype.setLoadingMessage=function(_25e,_25f,_260){
...
elt.innerHTML=HTMLArea._lc(_25e,_25f,_260);
};

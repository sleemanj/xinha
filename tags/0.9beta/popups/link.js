HTMLArea.prototype._createLink=function(_1){
var _2=this;
var _3=null;
...
_3={f_href:HTMLArea.is_ie?_2.stripBaseURL(_1.href):_1.getAttribute("href"),f_title:_1.title,f_target:_1.target,f_usetarget:_2.config.makeLinkShowsTarget};
}
...
if(!a){
try{
var _9=HTMLArea.uniq("http://www.example.com/Link");
